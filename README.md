...
> **[이 부분은 이미지 배치]**: 성적 추이 그래프 조회 화면 또는 메인 대시보드 스크린샷
> - 시스템의 전체적인 모습을 보여주는 대표 화면
> - 성적 추이 라인 그래프가 표시된 실제 조회 화면 권장
...
> **[이 부분은 이미지 배치]**: 성적 추이 그래프 실제 화면 캡처
> - 학생별 여러 강의의 성적을 보여주는 라인 그래프
> - 필터링 UI 및 데이터 포인트가 표시된 화면
...
> **[이 부분은 이미지 배치]**: 상세 ER 다이어그램
> - 각 테이블의 컬럼과 데이터 타입 포함
> - N:M 관계 및 외래키 관계선 명확히 표시
> - 카디널리티 표기 (1:N, N:M)
