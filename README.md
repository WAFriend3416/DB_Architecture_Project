...
#### 1. 비효율적인 인력 운용
- **3명의 선생님이 하루 8시간 중 약 4시간을 중복 입력·수정에 소비**
...
### 1. 문제 분석 및 요구사항 정의
기존 엑셀 파일을 분석하고 현장 근무자 인터뷰를 통해 주요 페인 포인트를 식별했습니다. 3명의 선생님이 하루 4시간씩 중복 작업을 수행하는 비효율적인 프로세스를 발견하고, 이를 웹 시스템으로 대체하는 방향을 제안했습니다.
